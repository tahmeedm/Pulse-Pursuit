...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, sprite_sheet_path, initial_x, initial_y):
        ...
        # Player base speed
        self.player_speed = Player.BASE_SPEED
    ...
    def enter_room(self, door_direction):
        match door_direction:
            case "N":
                self.y = self.y + PLAYABLE_HEIGHT - 1.5 * self.image.get_height()
            ...
            case "E":
                self.x = self.x - PLAYABLE_WIDTH + 1.5 * self.image.get_width()
